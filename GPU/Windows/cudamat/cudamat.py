...
_cudamat.apply_softmax.restype = ct.c_int
_cudamat.apply_sparse_dot.restype = ct.c_int
_cudamat.apply_sparse_mul.restype = ct.c_int
...
class CUDAMatrix(object):
    ...
    def apply_softmax(self, target = None, width = None):
        """
        Apply the logistic sigmoid to each element of the matrix.
        """
		
        return softmax(self, target, width)
		
    def apply_sparse_dot(self, target = None, width = None, data = None, ptr = None, indices = None, target_rows = None, target_coumns = None):
        """
        Apply the logistic sigmoid to each element of the matrix.
        
        """
        return sparse_dot(self, target, width, data, ptr, indices, target_rows, target_coumns)
    
    def apply_sparse_mul(self, target = None, width = None, data = None, ptr = None, indices = None):
        """
        Apply the logistic sigmoid to each element of the matrix.
        
        """
        return sparse_mul(self, target, width, data, ptr, indices)
...
def softmax(mat, target = None, width = None):
    """
    Apply the logistic sigmoid to each element of the matrix mat.
    """	
    if not target:
    ...
    err_code = _cudamat.apply_softmax(mat.p_mat, target.p_mat, width)
    if err_code:
        raise generate_exception(err_code)

    return target
	
def sparse_dot(mat, target = None, width = None, data = None, ptr = None, indices = None, target_rows = None, target_columns = None):
    """
    Apply the logistic sigmoid to each element of the matrix mat.
    """    
    ...
    err_code = _cudamat.apply_sparse_dot(mat.p_mat, target.p_mat, width, data.p_mat, ptr.p_mat, indices.p_mat,target_rows,target_columns )
    if err_code:
        raise generate_exception(err_code)

    return target

def sparse_mul(mat, target = None, width = None, data = None, ptr = None, indices = None):
    """
    Apply the logistic sigmoid to each element of the matrix mat.
    """    
    ...
    err_code = _cudamat.apply_sparse_mul(mat.p_mat, target.p_mat, width, data.p_mat, ptr.p_mat, indices.p_mat)
    if err_code:
        raise generate_exception(err_code)
